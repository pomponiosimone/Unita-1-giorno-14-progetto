...
*/
function deleteProp(object, Name) {
...
const modifiedObject = deleteProp(oggetto, "age");
console.log("Esercizio 11:", modifiedObject);
...
/* const newestMovie = function(movies) {
  let filmRecente = movies[0].Years;
...
console.log( newestMovie()) /* NON RIUSCITO
...
console.log("Esercizio 13 numero totali dei film:", countMovies());
...
const onlyTheYears = function (movies) {
  const arrayYear = [];
  for (let i = 0; i < movies.length; i++) arrayYear.push(movies[i].Year);
  return arrayYear;
};
...
console.log("Esercizio 16 somma anni film:", sumAllTheYears(movies));

/* ESERCIZIO 17
  Scrivi una funzione chiamata "searchByTitle" che riceve una stringa come parametro e ritorna i film nell'array "movies" fornito che la contengono nel titolo.
*/
const searchByTitle = function (stringa) {
  const filtredTitle = movies.filter(function (movie) {
    const titoliFilm = movie.Title;
    return titoliFilm.includes(stringa);
  });
  return filtredTitle;
};
console.log(
  "Esercizio 17 film che hanno titolo Lord of the Flies:",
...
/* const searchandDivide = function (stringa) {
  ...
  return {
      match: function (movies) {
          const filteredTitles = movies.filter(function(movie) {
              return movie.Title.includes(stringa);
          });
          return filteredTitles;
      }
  };
};
connsole.log(searchandDivide("Lord of the Flies")) */
...
console.log("Esercizio 20, funzione per selezionare id:",selezionaId())
/* ESERCIZIO 21
...
return tdElement}
console.log("Esercizio 21, funzione per selezionare tutti i td:", selezionaTD())
...
const tdElements = document.querySelectorAll("td");
  ...
  tdElements.forEach(td => {
      console.log("Esercizio 22:",td.textContent);
  });
}
stampaTesto()
